...
> 新的接口注册字符设备驱动需要两步
    ...
    module_test.c
        ...
        │   └── 第二步：注册字符设备驱动，关联fops结构体cdev_init + cdev_add完成真正的注册
        ├── 模块卸载函数yyy
        ...
        │     
        └── MODULE_LICENSE("GPL");
完整代码[module_test.c](https://github.com/TongxinV/oneBook/blob/master/0.5.Linux-Driver%20Development/assets/code2/module_test.c)
###字符设备驱动注册代码分析
