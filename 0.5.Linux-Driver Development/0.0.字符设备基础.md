...
```
用makefile编译好生成xxx.ko文件，拷贝到开发板下，insmod xxx.ko -> lsmod 查看相应模块变化信息 -> cat /proc/device 
可以看到对应的设备号和注册的驱动名称（这个是关键）
```
...
![](https://raw.githubusercontent.com/TongxinV/oneBook/master/0.5.Linux-Driver%20Development/assets/code4/0003.png)
